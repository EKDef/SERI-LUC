...
top_occ_sum_geo_sf <- top_occ_sum_geo_sf %>%
  bi_class(
    ...
    style = "quantile",  # or "equal" depending on your needs
...
bivariate_map <- ggplot(top_occ_sum_geo_sf) +
  ...
  labs(
    title = "Bivariate plot of Agriculture vs Top 10 Skill-Matched Industry Employment (%)",
    subtitle = "Comparison of Agricultural and Top 10 Occupation Percentages by MSOA",
    caption = "Source: Census Employment Data"
  ) +
  theme_minimal() +
  theme(
    panel.grid.major = element_blank(),
...
# Save the plot
ggsave("bi_chorop_agri_skill_match.png", device = "png", width = 45, height = 45, dpi = 200)
